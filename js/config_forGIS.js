	...
	var globalParameters = {
			...
			data : {
				...
				epiDataset : {
					...
					source : "data/ebonyi_lassa_2018-2019-2020_negative.csv",
		    ...
		    layout : {
		        ...
		        appTitle : "NIGERIA - Ebonyi State - 2018/2019/2020 Lassa Fever | Negative Cases",
	        ...
	        chartsLayout : {
	            ...
	            combined : {
	                ...
	                bars : {
	                    legend  : "Bars : New weekly negative cases",
	                    axis    : "New weekly cases",
	                    tooltip : "New negative cases"                    
	                },
	                line : {
	                    legend  : "Line : Cumulated negative cases",
	                    axis    : "Cumulated cases",
	                    tooltip : "Cumulated negative cases"                    
	                }                
	            }
	        },
	};
